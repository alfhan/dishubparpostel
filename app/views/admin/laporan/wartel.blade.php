...
?>
 ...
 <table width="326">
 <tr><th colspan="8">DINAS PERHUBUNGAN, KEBUDAYAAN, PARIWISATA, POS DAN TELEKOMUNIKASI</th></tr>
 <tr><th colspan="8">{{$dataInstansi->kabkota()->first()->name}}</th></tr>
 <tr><th colspan="8">BULAN <? echo $bulan;?> <? echo date("Y");?></th></tr>
 <tr></tr>
 </table>
 <table border="1">
    ...
    @foreach($datawartel as $wartel)
      <tr>
         ...
         <td align="center">{{ $wartel->jumlah_kbu }}</td>
         <td>{{ $wartel->pemilik }}</td>
         <td>{{ $wartel->alamat }}</td>
         <td align="center">{{ $wartel->telepon }}</td>
